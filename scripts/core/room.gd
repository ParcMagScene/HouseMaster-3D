...
# --- Couleurs par type ---
var type_colors := {
	"living": Color(0.9, 0.85, 0.7),
	"bedroom": Color(0.75, 0.82, 0.9),
	"bathroom": Color(0.7, 0.9, 0.92),
	"wc": Color(0.8, 0.8, 0.85),
	"storage": Color(0.82, 0.78, 0.7),
	"kitchen": Color(0.92, 0.88, 0.75),
	"generic": Color(0.85, 0.85, 0.85),
}
...
func _generate_floor_mesh() -> void:
	...
	mat.albedo_color = type_colors.get(room_type, Color(0.85, 0.85, 0.85))
